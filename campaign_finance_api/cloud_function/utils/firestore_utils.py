...
# Remove or comment out logging.basicConfig from here
...
def get_firestore_client():
    ...
    # Read the database id once with the proper default
    database_id = os.getenv("FIRESTORE_DATABASE_ID", "(default)")
    print("--------------------")
    print(database_id)
    print("--------------------")
    logging.debug(
        f"Environment Variables: FIRESTORE_EMULATOR_HOST={emulator_host}, "
